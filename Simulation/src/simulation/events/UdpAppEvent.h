...
#ifndef SIMULATION_EVENTS_UDPAPPEVENT_H_
#define SIMULATION_EVENTS_UDPAPPEVENT_H_
 ...
 * \ingroup events
 *
 * \brief Event implementation that uses applications and communicates via udp protocol.
 *
 ...
 * \see getCurrentRSS()
 */
class UdpAppEvent: public Event {
...
protected:
	UdpAppEvent(NodePtr source, NodePtr dest, uint32_t bytes);
...
#endif /* SIMULATION_EVENTS_UDPAPPEVENT_H_ */
