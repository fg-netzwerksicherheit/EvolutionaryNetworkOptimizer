...
void check_p2pnetml_correct(std::string input, std::string output) {
	P2PNetMLHandler P2PMLIO;
	std::shared_ptr<Topology> t1 = make_shared<Topology>();
	std::shared_ptr<Topology> t2 = make_shared<Topology>();
	t1 = P2PMLIO.ReadGraph(input);
	P2PMLIO.WriteGraph(t1, output);
	t2 = P2PMLIO.ReadGraph(output);
...
BOOST_AUTO_TEST_CASE(P2PnetMLTest) {
	//another test case................................................................
	std::string in_path = GetProjectAnyGraphDirectory() + "/Resources/UnitTestInput1.p2pnetml";
	std::string out_path = GetProjectAnyGraphDirectory() + "/Resources/UnitTestOutput1.p2pnetml";
	//another test case................................................................
	std::string in_path1 = GetProjectAnyGraphDirectory() + "/Resources/UnitTestInput2.p2pnetml";
	std::string out_path1 = GetProjectAnyGraphDirectory() + "/Resources/UnitTestOutput2.p2pnetml";
	//another test case................................................................
	std::string in_path2 = GetProjectAnyGraphDirectory() + "/Resources/UnitTestInput3.p2pnetml";
	std::string out_path2 = GetProjectAnyGraphDirectory() + "/Resources/UnitTestOutput3.p2pnetml";
	//end...........................................................................
	check_p2pnetml_correct(in_path, out_path);
	check_p2pnetml_correct(in_path1, out_path1);
	check_p2pnetml_correct(in_path2, out_path2);
