...
std::shared_ptr<Topology> GraphMLHandler::ReadGraph(std::string file_name) {
...
void GraphMLHandler::WriteGraph(std::shared_ptr<Topology> topo, std::string file_name) {
	XMLDocument xmlDoc;
	std::string filetype = "graphml";
